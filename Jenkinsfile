pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://13.61.150.180:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/jajulagnanadeepak/fullstack.git', branch: 'master'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://13.61.150.180:9090/springapp1"
            echo "✅ Frontend deployed: http://13.61.150.180:9090/frontapp1"
        }
        failure {
